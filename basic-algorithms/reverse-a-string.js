...
const result_one = reverseString("Bangladesh");
console.log(result_one); // Should return "hsedalgnaB"
...
function reverseString_with_loop(string) {
...
const result_two = reverseString_with_loop("Bangladesh");
